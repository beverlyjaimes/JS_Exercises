 ...
 */
    ...
    let abill = prompt("What is the amount of your bill?");
    let apercentage = prompt("What tip percentage would you like to leave?");
    let atip = alert("Your tip is $" + calculateTip(abill, apercentage));
